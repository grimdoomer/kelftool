...
static uint8_t USER_HEADER_BMCC[16] = { 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00 };
...
public:
    ...
    int SaveKelf(std::string filename, UserHeaderId header);
    int LoadContent(std::string filename, UserHeaderId header);
